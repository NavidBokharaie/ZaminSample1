...
using MiniBlog.Infra.Data.Sql.Commands.Common.AuditableShadowProperty;
...
public static class HostingExtensions
{
    public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddDbContext<MiniblogCommandDbContext>(c => c.UseSqlServer(cnn).AddInterceptors(new SetPersianYeKeInterceptor(), new AggregateExcludableAddAuditDataInterceptor()));
